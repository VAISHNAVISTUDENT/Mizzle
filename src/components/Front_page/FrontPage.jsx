...
export default function Home() {
  return (
    <>
      ...
      <section className="position-relative overflow-hidden pb-0 pt-xl-9 mt-3">
        <div className="position-absolute top-0 start-0 ms-n7 d-none d-xl-block">
          <img src="/mizzle_ng/assets/decoration-pattern-BCMwgJTN.svg" alt="" />
        </div>
        ...
        <div className="container pt-4 pt-sm-5">
          <div className="row g-xl-5">
              ...
              <div className="pe-xxl-4">
                ...
                <h1 className="mt-3 lh-base">
                  ...
                  <span className="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block">
                    <span id="type1" className="ityped-cursor"><App></App></span>
                ...
                <form className="col-md-10 bg-body border rounded-2 position-relative p-2 mt-4 mt-md-5">
                  <div className="input-group">
                    <input
                      id="__BVID__642055___BV_input__"
                      className="form-control focus-shadow-none border-0 me-1"
                      type="email"
                      placeholder="Enter your email address"
                    />
                    <button
                      className="btn btn-md btn-dark rounded-2 mb-0"
                      type="button"
                    >
                      Start trial!
                    </button>
            ...
            <div className="col-md-10 col-xl-5 position-relative mx-auto mt-7 mt-xl-0">
              ...
              <div className="card d-inline-block shadow rounded-4 position-absolute end-0 top-0 p-3 me-lg-n3 me-xxl-n7 mt-n5 d-none d-sm-block">
                <p className="light-mode-item h-20px mb-2">★ trustpilot</p>
                <div className="d-flex align-items-center">
                  <img
