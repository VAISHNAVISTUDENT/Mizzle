    ...
    <div className="row justify-content-xl-start justify-content-center flex-xl-nowrap">
      <div className="col-xl-6 ps-xl-5 mb-8 mb-xl-0">
        ...
        <div className="d-flex gap-3 gap-sm-4 flex-wrap mt-4 mt-md-5">
          <button className="btn btn-sm btn-dark mb-0" type="button">
            Discover features
          </button>
          <a
            aria-current="page"
            href="/mizzle_ng/saas/v2"
            className="router-link-active router-link-exact-active icon-link icon-link-hover heading-color text-success-hover mb-0" 
      ...
      <div
        className="col-xl-10 d-flex rotate-343 position-relative aos z-index-2 aos-init aos-animate"
        data-aos="zoom-in-up"
        data-aos-delay={200}
      ...
      >
        ...
        <div className="">
          <img
            src="/mizzle_ng/assets/01-CTjRRi4d.png"
            data-depth="0.5"
            className="layer position-absolute top-0 end-0  h-25 "
            alt=""
            style={{
        ...
        />
        <img
          src="data:image/png;base64,"
          style={{
            transform: "rotate(-15deg) translateX(100px) translateY(-240px)",
            padding: 20,
            height: 150,
            width: 300
          }}
        ...
        />
        <img
          src="https://themes.stackbros.in/mizzle_ng/assets/04-BQ0z6fnq.png"
          data-depth="0.3"
          className=" layer position-absolute bottom-0 end-0 me-9 mb-4 d-none d-sm-block"
          alt=""
          style={{
            transform: "rotate(-15deg) translateX(-250px) translateY(-300px)",
            padding: 20
          }}
        />
      </div>
